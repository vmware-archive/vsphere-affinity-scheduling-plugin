...
func TestPodAntiAffinity(t *testing.T) {
	tests := []struct {
		...
		{
			desc: "pod anti-affinity; pod matchLabels; nodes on different hosts.",
			pod: &v1.Pod{
				Spec: v1.PodSpec{
		...
		{
			desc: "pod anti-affinity; pod matchLabels; nodes on same hosts.",
			pod: &v1.Pod{
				Spec: v1.PodSpec{
					Affinity: &v1.Affinity{
						PodAntiAffinity: &v1.PodAntiAffinity{
		...
		{
			desc: "pod anti-affinity; pod matchLabels; no matching pods",
			pod: &v1.Pod{
				Spec: v1.PodSpec{
					Affinity: &v1.Affinity{
						PodAntiAffinity: &v1.PodAntiAffinity{
