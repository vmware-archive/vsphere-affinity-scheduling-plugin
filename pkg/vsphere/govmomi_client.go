...
// Shameless copied from github.com/vmware/govmomi/examples
...
var urlDescription = fmt.Sprintf("vCenter URL [%s]", envURL)
var urlFlag = flag.String("url", getEnvString(envURL, "https://username:password@host/sdk"), urlDescription)

var insecureDescription = fmt.Sprintf("Don't verify the certificate chain from vSphere [%s]", envInsecure)
